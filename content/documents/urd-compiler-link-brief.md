---
title: "Compiler Phase 3: LINK"
slug: "urd-compiler-link-brief"
description: "Declaration collection, reference resolution, ID derivation, and scope enforcement. Defines the LINK phase — the two-pass algorithm that populates the symbol table, resolves all cross-file and intra-file references, derives compiled IDs, and enforces non-transitive import visibility."
category: "brief"
format: "Task Brief"
date: "2026-02-17"
status: "Active"
...
tags:
  ...
  - formalisation
details:
  - "Two-pass algorithm: collection then resolution"
  - "Symbol table population with duplicate detection"
  - "ID derivation: slugification for locations, choices, sequences, phases"
  - "Visible scope enforcement per non-transitive import rules"
  - "Choice-to-action compilation during collection"
---
