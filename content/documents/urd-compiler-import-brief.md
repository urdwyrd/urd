---
title: "Compiler Phase 2: IMPORT"
slug: "urd-compiler-import-brief"
description: "Import resolution, dependency graph construction, and file ordering. Defines the IMPORT phase — recursive file discovery, path normalisation, cycle detection, depth limits, file stem uniqueness, casing mismatch detection, and deterministic topological sorting."
category: "brief"
format: "Task Brief"
date: "2026-02-17"
status: "Active"
...
tags:
  ...
  - formalisation
details:
  - "Depth-first import graph traversal with cycle detection"
  - "Path normalisation: forward slashes, relative to entry, no symlink resolution"
  - "Casing mismatch detection for cross-platform portability"
  - "File stem uniqueness enforcement for section ID construction"
  - "Deterministic topological sort with alphabetical tiebreaking"
---
