---
title: "Urd Forge — Application Architecture"
slug: "urd-forge-application-architecture"
description: "Full architecture specification for Urd Forge, a Tauri-based desktop IDE for authoring Urd interactive fiction worlds. Covers BSP tiling layout engine, 85+ specialised views, command registry, message bus, projection layer, workspace management, theme engine, and eight-phase implementation plan."
...
tags:
  ...
  - projections
details:
  - "Tauri 2.x shell with Rust backend and Svelte 5 frontend"
  - "BSP zone tree layout engine with split/join/swap/resize operations"
  - "85+ specialised views as projections over a single CompilerOutput"
  - "Framework/Application layer separation — generic IDE framework has no knowledge of Urd"
  - "Command registry, message bus, navigation broker, workspace management"
  - "Eight-phase implementation plan from framework shell to production polish"
---
