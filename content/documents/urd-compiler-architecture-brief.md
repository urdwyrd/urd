...
slug: "urd-compiler-architecture-brief"
description: "The internal blueprint for the five-phase compiler pipeline. Defines the AST, symbol table, diagnostic collector, dependency graph, phase interface contracts, ID derivation rules, error recovery strategy, and the two-pass model that connects all phases."
category: "brief"
format: "Task Brief"
date: "2026-02-17"
status: "Active"
...
tags:
  ...
  - formalisation
details:
  - "Five-phase pipeline: PARSE → IMPORT → LINK → VALIDATE → EMIT"
  - "AST node types, span tracking, and annotation model"
  - "Symbol table with OrderedMap and visible scope enforcement"
  - "Diagnostic collector with phase-specific code ranges"
  - "ID derivation rules for entities, sections, choices, and locations"
---
