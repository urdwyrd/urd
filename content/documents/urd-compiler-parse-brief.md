---
title: "Compiler Phase 1: PARSE"
slug: "urd-compiler-parse-brief"
description: "Source text to per-file Abstract Syntax Trees. Defines the PARSE phase — frontmatter and narrative content parsing, two-region detection, block dispatch, condition expression parsing, choice nesting, error recovery with synchronisation points, and span-accurate AST production."
category: "brief"
format: "Task Brief"
date: "2026-02-17"
status: "Active"
...
tags:
  ...
  - formalisation
details:
  - "Two-region parsing: frontmatter sub-parser and narrative content parser"
  - "Block dispatch order matching PEG grammar ordered choice"
  - "Structured condition expression parsing into typed variants"
  - "Choice nesting with indent-level tracking"
  - "Synchronisation-point error recovery with ErrorNode markers"
---
