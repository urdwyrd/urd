---
title: "Compiler Phase 5: EMIT"
slug: "urd-compiler-emit-brief"
description: "Transforms validated ASTs and the symbol table into a single .urd.json string conforming to the Urd World Schema. Defines the EMIT phase — block assembly, condition lowering, effect lowering, keyword expansion, deterministic serialisation, and the fixed top-level key order."
category: "brief"
format: "Task Brief"
date: "2026-02-17"
status: "Active"
...
tags:
  ...
  - formalisation
details:
  - "Eight-step block assembly: world, types, entities, locations, rules, actions, sequences, dialogue"
  - "Condition lowering from AST nodes to JSON expression strings"
  - "Effect lowering to structured JSON objects"
  - "Keyword expansion: here → player.container, player → player"
  - "Deterministic byte-identical output with fixed key ordering"
---
