---
title: "Compiler Phase 4: VALIDATE"
slug: "urd-compiler-validate-brief"
description: "Type checking, constraint enforcement, and semantic validation. Defines the VALIDATE phase — property type checking, range and enum constraints, trait validation, structural constraints, condition and effect validation, and the skip rule that prevents cascading errors from unresolved references."
category: "brief"
format: "Task Brief"
date: "2026-02-17"
status: "Active"
...
tags:
  ...
  - formalisation
details:
  - "Property type checking: boolean, integer, number, string, enum, ref, list"
  - "Range, enum membership, and ref-type constraint enforcement"
  - "Trait validation: portable for move, container for destinations"
  - "Structural constraints: action mutual exclusion, nesting depth, world config"
  - "Skip rule prevents cascading errors from LINK failures"
---
