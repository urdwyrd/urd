...
> Covers the runtime (Wyrd), testing framework, and system-level acceptance criteria. The compiler gate is defined separately in the v1 Completion Gate: Compiler document.
> February 2026.
...
See the v1 Completion Gate: Compiler document for current status.
...
*This document is the reference for system-level completion. The compiler gate is defined separately in the v1 Completion Gate: Compiler document.*
